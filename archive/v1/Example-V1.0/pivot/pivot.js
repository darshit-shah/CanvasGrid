function getData() {
  fieldData = [{
    ...
    "colWidthType": "px",
    "isMasterView": 1,
    "calculateFormula": "10*10"
  }];

  var tableData = [];
  for (var i = 1; i <= 15; i++) {
    var formatting = JSON.stringify({
      "City": {},
      "State": {}
    });
    tableData.push({
      ...
      "rowID": i,
      "createdDate": 1413279409,
      "modifiedDate": 1413794179,
      "createdBy": 1,
      "modifiedBy": 1,
      "createdIP": "127.0.0.1",
...
function loadTable(data) {
  if (data.status == true) {
    ...
    axiomPivotHelper.prepareData({
      collapsible: true,
      showSummary: $('#chkShowSummary').is(":checked"),
      repeatContent: $('#chkRepeatContent').is(":checked"),
